...
public class NameplateManager implements Listener{
	...
	public void onPlayerJoin(final PlayerJoinEvent e){
		...
		if(team == null){
			...
			if(suffix)
				team.setSuffix(this.suffixFormat.replaceAll("%f", faction.getName()));
			if(prefix)
				team.setPrefix(this.prefixFormat.replaceAll("%f", faction.getName()));
		}
